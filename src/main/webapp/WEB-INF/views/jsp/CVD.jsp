...
<table class="table table-bordered table-hover" style="margin-top:30px;">
    <caption>
        <h2 style="margin-top:40px; color:white;" align="center">CVD预约</h2>
    </caption>
    <thead>
    <tr class="info">
        <td align="center" valign="middle">CVD预约</td>
    ...
    <tr class="success">
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[0]==false && isPast[0] == false}">
                <a href="/order?token=${param.token}&day=1&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[4]==false && isPast[4] == false}">
                <a href="/order?token=${param.token}&day=2&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[8]==false && isPast[8] == false}">
                <a href="/order?token=${param.token}&day=3&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[12]==false && isPast[12] == false}">
                <a href="/order?token=${param.token}&day=4&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[16]==false && isPast[16] == false}">
                <a href="/order?token=${param.token}&day=5&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[20]==false && isPast[20] == false}">
                <a href="/order?token=${param.token}&day=6&time=09:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
    ...
    <tr class="success">
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[1]==false && isPast[1] == false}">
                <a href="/order?token=${param.token}&day=1&time=10:00:00&instrumentID=001">9:00-10:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[5]==false && isPast[5] == false}">
                <a href="/order?token=${param.token}&day=2&time=10:00:00&instrumentID=001">10:00-11:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[9]==false && isPast[9] == false}">
                <a href="/order?token=${param.token}&day=3&time=10:00:00&instrumentID=001">10:00-11:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[13]==false && isPast[13] == false}">
                <a href="/order?token=${param.token}&day=4&time=10:00:00&instrumentID=001">10:00-11:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[17]==false && isPast[17] == false}">
                <a href="/order?token=${param.token}&day=5&time=10:00:00&instrumentID=001">10:00-11:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[21]==false && isPast[21] == false}">
                <a href="/order?token=${param.token}&day=6&time=10:00:00&instrumentID=001">10:00-11:00</a>
            </c:if>
    ...
    <tr class="success">
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[2]==false && isPast[2] == false}">
                <a href="/order?token=${param.token}&day=1&time=14:00:00&instrumentID=001">14:00-15:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[6]==false && isPast[6] == false}">
                <a href="/order?token=${param.token}&day=2&time=14:00:00&instrumentID=001">14:00-15:00</a>
            </c:if>
        ...
        <c:if test="${isOrdered[10]==false && isPast[10] == false}">
            <a href="/order?token=${param.token}&day=3&time=14:00:00&instrumentID=001">14:00-15:00</a>
        </c:if>
        ...
        <c:if test="${isOrdered[14]==false && isPast[14] == false}">
            <a href="/order?token=${param.token}&day=4&time=14:00:00&instrumentID=001">14:00-15:00</a>
        </c:if>
        ...
        <c:if test="${isOrdered[18]==false && isPast[18] == false}">
            <a href="/order?token=${param.token}&day=5&time=14:00:00&instrumentID=001">14:00-15:00</a>
        </c:if>
        ...
        <c:if test="${isOrdered[22]==false && isPast[22] == false}">
            <a href="/order?token=${param.token}&day=6&time=14:00:00&instrumentID=001">14:00-15:00</a>
        </c:if>
    ...
    <tr class="success">
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[3]==false && isPast[3] == false}">
                <a href="/order?token=${param.token}&day=1&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[7]==false && isPast[7] == false}">
                <a href="/order?token=${param.token}&day=2&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[11]==false && isPast[11] == false}">
                <a href="/order?token=${param.token}&day=3&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[15]==false && isPast[15] == false}">
                <a href="/order?token=${param.token}&day=4&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[19]==false && isPast[19] == false}">
                <a href="/order?token=${param.token}&day=5&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
        ...
        <td align="center" valign="middle">
            ...
            <c:if test="${isOrdered[23]==false && isPast[23] == false}">
                <a href="/order?token=${param.token}&day=6&time=15:00:00&instrumentID=001">15:00-16:00</a>
            </c:if>
...
<%-- 测试${ispast是否取到}
    <c:forEach items="${isPast}" var="flag">--%>
